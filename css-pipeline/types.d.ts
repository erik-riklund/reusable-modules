 ...
 */
export type AbstractTree = Array<Block>;
 ...
 */
export type InputPlugin = { stage: 'input', handler: (input: string) => string };
 ...
 */
export type Plugin = InputPlugin | TransformPlugin | OutputPlugin;
 ...
 */
export type TransformPlugin = { stage: 'transform', handler: (block: MutableBlock) => void };
