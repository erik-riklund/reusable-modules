...
import type { Block, Property, RenderState } from 'css-pipeline/types'

/**
 * Renders a single CSS block and its children into the render state.
 */
export const renderBlock = (
  state: RenderState, block: Block, context = 'root', parents: string[] = []) =>
{
 ...
 */
const renderBlockContent = (state: RenderState,
  context: string, selectors: string[], block: Block) =>
{
