...
import type { AbstractTree, Block, TransformPlugin } from 'css-pipeline/types'

/**
 * Transforms the abstract syntax tree by applying a series of plugins.
 */
export const transformTree = (
  tree: AbstractTree, plugins: TransformPlugin[]) =>
{
 ...
 */
export const makeMutableBlock = (block: Block) =>
{
